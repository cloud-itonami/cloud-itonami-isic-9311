# Operator Quickstart — Operation of sports facilities

Shortest path from clone to a verified local dry-run for **ISIC 9311** (`cloud-itonami-isic-9311`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9311.git
cd cloud-itonami-isic-9311
```
...
- Blueprint governor key: `facility-safety-governor`
- Likely source path: `facility.governor.cljc`
